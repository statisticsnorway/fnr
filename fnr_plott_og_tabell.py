...
def plott_fylke(df, fnr):
    ...
    def skriv_tabell(aargang, aggregering, aggregat, variabel, fylker, stack, forste_diff, bred):
        try:
            (
                fnr
    ...
    ui = HBox([VBox([stack_wgt, first_diff_wgt, wide_by_wgt, aargang_wgt, variabel_wgt]), VBox([aggregering_wgt, aggregat_wgt]), VBox([regionsreformer_wgt, fylker_wgt])])
